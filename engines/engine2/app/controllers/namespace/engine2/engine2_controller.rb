module Namespace
  module Engine2
    class Engine2Controller < ApplicationController
      soap_service namespace: "#{Rails.configuration.default_api_namespace}mounted/soap_api/#{controller_name}/wsdl", description: 'Very cool description about this service'
