module MyEngine
  class TestEngine1Controller < ApplicationController
    soap_service namespace: "#{Rails.configuration.default_api_namespace}engine1/#{controller_name}/wsdl", description: 'Very cool description about this service'
