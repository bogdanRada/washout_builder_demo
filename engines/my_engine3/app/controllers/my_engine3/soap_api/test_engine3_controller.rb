module MyEngine3
  module SoapApi
  class TestEngine3Controller < ApplicationController
    soap_service namespace: "/engine1/#{controller_name}/wsdl", description: 'Very cool description about this service'
